...
from ..state.monitoring import RegionState, StateInfrastructure, CapitalState
...
class CapitalNode(KeyInfraNode):
    ...
    def region_update(self, body: dict):
        ...
        # digest: str = 
        # print(f'[capital={self.get_network_name()}] Resulting state: {Fore.LIGHTBLACK_EX}{self.get_state()}{Fore.RESET} {Fore.YELLOW}({3}..){Fore.RESET}')
